            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('pegawaiobat.index') }}"
                                class="nav-link @if ($Sidebar == 'obat') active @endif">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('pegawaipasien') }}"
                                class="nav-link @if ($Sidebar == 'pasien') active @endif">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('pegawaitindakan') }}"
                                class="nav-link @if ($Sidebar == 'tindakan') active @endif">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('pegawaipembayaran.index') }}"
                                class="nav-link @if ($Sidebar == 'pembayaran') active @endif"">
        ...
        $(document).ready(function() {
            ...
            $(".addMore").click(function() {
                if ($('body').find('.fieldGroup').length < maxGroup) {
                    var fieldHTML = '<div class="form-group fieldGroup col-4">' + $(".fieldGroupCopy")
                        .html() +
                        '</div>';
                    $('body').find('.fieldGroup:last').after(fieldHTML);
                } else {
                    alert('Tidak boleh terlalu banyak obat, Max hanya ' + maxGroup);
                }
            });
